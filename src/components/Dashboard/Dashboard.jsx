        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px', flexWrap: 'wrap' }}>
            ...
            <span style={{
              ...
              padding: '2px 8px',
              borderRadius: '100px',
              background: task.status === 'completed' ? '#dcfce7' : task.status === 'in_progress' ? '#fef9c3' : 'var(--surface2)',
              color: task.status === 'completed' ? '#166534' : task.status === 'in_progress' ? '#854d0e' : 'var(--text-muted)',
              fontWeight: '600',
            }}>
